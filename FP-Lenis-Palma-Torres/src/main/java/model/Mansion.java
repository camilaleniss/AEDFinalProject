...
import java.util.*;
/**
 * This class represents the Winchester Mansion implementing a graph to model the distribution of it
 * This class do the requeriments
 * @author Maria Camila Lenis Restrepo, Juan Sebastian Palma, Javier Andrés Torres Reyes
 *
 */
public class Mansion {
	...
	/**
	 * True  if it is represented by an adjacent list
	 * False if it is represented by an adjacent matrix
	 */
	private boolean isList;
	/**
	 * The constructor of the mansion
	 * It initialize the state of the mansion
	 * @param isList
	 */
	 ...
	 * @throws CorridorAlreadyExistsException If the corridor already exists
	 * The graph does not super multi edges
	 */
